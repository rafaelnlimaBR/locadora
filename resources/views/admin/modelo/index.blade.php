                    ...
                    <table id="example2" class="table table-bordered table-hover">
                        ...
                        @foreach($modelos as $r)
                            <tr>
                                ...
                                <td>
                                    <a href="{!! route('modelo.detalhes',['id'=>$r->id]) !!}" class="btn btn-social-icon btn-info"><i class="fa fa-eye"></i></a>
                                    <a href="{!! route('modelo.editar',['id'=>$r->id]) !!}" class="btn btn-social-icon btn-success"><i class="fa fa-edit"></i></a>
