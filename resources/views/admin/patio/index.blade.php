...
@section('conteudo')
    <div class="row">
        <div class="col-xs-12">
            <div class="botoes">
                <a href="{!! route('patio.novo') !!}" class="btn btn-success"><i class="fa fa-plus"> </i>  Novo Registro</a>
            </div>
        </div>
    </div>
        ...
        <div class="col-xs-12">
            <div class="box box-success">
                <div class="box-header">
                    ...
                    <div class="row">
                        {!! Form::open(['route'=>['patio.pesquisa'],'method'=>'post']) !!}
                    ...
                    <table id="example2" class="table table-bordered table-hover">
                        ...
                        @foreach($patios as $r)
                            <tr>
                                ...
                                <td>
                                    <a href="{!! route('patio.detalhes',['id'=>$r->id]) !!}" class="btn btn-social-icon btn-info"><i class="fa fa-eye"></i></a>
                                    <a href="{!! route('patio.editar',['id'=>$r->id]) !!}" class="btn btn-social-icon btn-success"><i class="fa fa-edit"></i></a>
    ...
    @include('admin.patio.includes.excluir')
@endsection