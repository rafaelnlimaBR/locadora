...
@section('conteudo')
    <div class="row">
        <div class="col-xs-12">
            <div class="botoes">
                <a href="{!! route('acessorio.novo') !!}" class="btn btn-success"><i class="fa fa-plus"> </i>  Novo Registro</a>
            </div>
        </div>
    </div>
        ...
        <div class="col-xs-12">
            <div class="box box-success">
                <div class="box-header">
                    ...
                    <div class="row">
                        {!! Form::open(['route'=>['acessorio.pesquisa'],'method'=>'post']) !!}
                ...
                <div class="box-body">
                    <table id="example2" class="table table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <th style="width: 18%">Criado</th>
                            <th style="width: 20%;"></th>

                        </tr>
                        </thead>
                        <tbody>
                        @foreach($acessorios as $r)
                            <tr>
                                <td>{!! $r->id !!}</td>
                                <td>{!! $r->nome !!}</td>
                                <td>{!! $r->qnt !!}</td>
                                ...
                                <td>{!! $r->created_at !!}</td>
                                <td>
                                    <a href="{!! route('acessorio.detalhes',['id'=>$r->id]) !!}" class="btn btn-social-icon btn-info"><i class="fa fa-eye"></i></a>
                                    <a href="{!! route('acessorio.editar',['id'=>$r->id]) !!}" class="btn btn-social-icon btn-success"><i class="fa fa-edit"></i></a>
    ...
    @include('admin.acessorio.includes.excluir')
@endsection